...
def get_perspective_matrix(perspective=0.0):
    ...
    :return:
    """
    if perspective is None or not isinstance(perspective, (int, float)) or perspective < 0:
        raise ValueError("Invalid perspective value. It must be a non-negative number.")
    P = np.eye(3)
